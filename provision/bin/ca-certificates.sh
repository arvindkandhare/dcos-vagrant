...
echo ">>> Installing EMC Network Certificates"

cat << EOF > /etc/pki/ca-trust/source/anchors/EMC_Root_CA.crt
-----BEGIN CERTIFICATE-----
...
cat << EOF > /etc/pki/ca-trust/source/anchors/EMC_SSL_Decryption_Authority.crt
-----BEGIN CERTIFICATE-----
